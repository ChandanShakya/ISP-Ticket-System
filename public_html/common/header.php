    ...
    <nav class="navbar navbar-dark navbar-expand-md bg-dark py-3">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="index.php">
            ...
            <div id="navcol-5" class="collapse navbar-collapse text-end">
                ...
                </ul><a class="btn btn-primary ms-md-2" role="button" id="loginButton" href="login.php"><svg class="bi bi-person-badge" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" style="width: 2em;height: 2em;margin: 0em 0.5em 0em 0em;">
